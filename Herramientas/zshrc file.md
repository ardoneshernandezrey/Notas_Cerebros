...
alias obs='open -a "Obsidian" "$NOTAS_DIR"'
...
    echo "🔎 Buscando '$1' en todas tus notas..."

    # **/*.md busca en la raíz y en todas las subcarpetas
...
alias organizar="$HOME/Notas_Cerebro/organizar_cerebro_ultra.sh"
...
# ENVIAR Y ABRIR NOTA EN GALAXY TAB ACTIVE 3

# ═════════════════════════════════════════════════════════════ 

# ══════════════════════════════════════════════════════════════

# ENVIAR NOTA DIRECTO A LA BÓVEDA 'Ardon' EN GALAXY TAB
...
    local IP_TAB="192.168.1.188"

    local USER_TAB="u0_a325"

    local PUERTO="8022"

    local DESTINO="~/storage/shared/Documents/Ardon/"

  

    echo "📤 Enviando $1 a la Bóveda Ardon en la Galaxy Tab..."

  

    # Copia limpia por SCP directo a la carpeta de la bóveda

    scp -P $PUERTO "$1" "${USER_TAB}@${IP_TAB}:${DESTINO}"

  

    if [ $? -eq 0 ]; then

        echo "✅ ¡Nota sincronizada con la bóveda de la tablet!"

    else

        echo "❌ Error al conectar con la tablet. Verifica que 'sshd' esté activo en Termux."

    fi

}

alias check-knox="python3 /Users/ardon/proyectos/scrip/check_knox.py"

  

# Perro Guardián Knox en segundo plano

alias knox-guard="python3 /Users/ardon/proyectos/scrip/knox_watchdog.py"

  

# Sincronización de Archivos Tab Active3 -> Mac

alias sync-tab="python3 /Users/ardon/proyectos/scrip/sync_tab.py"

alias tab-control="python3 /Users/ardon/proyectos/scrip/tab_control.py"

  

export GEMINI_API_KEY="AIzaSyBb9gRQv531pgl3kSWSu4v76mF9W2zU-x8E"
